 ...
 <spring:hasBindErrors name="user">
    <font color="red">
	 ...
	 <table>
	   <tr>
	   		<td width="10%">아이디</td>
			<td><form:input path="userid" readonly="true" class="w3-input"/>
	   ...
	   <tr>
		   <td>전화번호</td>
		   <td><form:input path="phoneno" class="w3-input"/></td>
	   </tr>
	   <tr>
		   <td>우편번호</td>
		   <td><form:input path="postcode" class="w3-input"/></td>
	   </tr>
	   <tr>
	   		<td>주소</td><td><form:input path="address" class="w3-input"/></td>
	   </tr>
	   <tr>
	   		<td>이메일</td><td><form:input path="email" class="w3-input"/>
