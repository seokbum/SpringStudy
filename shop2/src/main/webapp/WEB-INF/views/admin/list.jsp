...
<div class="container my-5">
    ...
    <form action="mailForm" method="post">
        ...
        <div class="mt-3 text-end">
            <button type="submit" class="btn btn-success me-2"><i class="bi bi-envelope-fill"></i> 선택 회원에게 메일 보내기</button>
            <a href="../user/mypage" class="btn btn-secondary"><i class="bi bi-person-fill"></i> 마이페이지</a>
        </div>
    </form>
</div>
